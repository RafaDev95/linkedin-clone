...
const Sidebar = () => {
  ...
  return (
    <div className="space-y-2 min-w-max max-w-lg">
      <div
        className="bg-white dark:bg-[#1D2226] rounded-lg overflow-hidden relative flex 
      ...
      >
        ...
        <Avatar
          ...
          // src="/bleach.jpg"
          className="!h-14 !w-14 !border-2 !absolute !top-4 !curosr-pointer"
        />
        <div className="mt-5 py-4 space-x-0.5">
          <h4 className="hover:underline decoration-blue-700 underline-offset-4 cursor-pointer">
            {session?.user?.name}
          </h4>
        ...
        <div className="hidden md:inline text-left dark:text-white/75 text-sm">
          <div className="font-medium sidebarButton space-y-0.5">
            ...
            <div className="flex justify-between space-x-2">
              ...
              <span className="text-blue-500">1231</span>
            </div>
          </div>
